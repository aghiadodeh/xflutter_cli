...
class _$ProductImpl implements _Product {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.originalPrice, originalPrice) || other.originalPrice == originalPrice) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, price, originalPrice, description, color, size, status, createdAt, user,
      const DeepCollectionEquality().hash(_media), category);
