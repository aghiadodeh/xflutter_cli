...
class _$VerifyCodeRequestImpl implements _VerifyCodeRequest {
  const _$VerifyCodeRequestImpl({this.email, this.verificationCode});
...
abstract class _VerifyCodeRequest implements VerifyCodeRequest {
  const factory _VerifyCodeRequest({final String? email, final String? verificationCode}) = _$VerifyCodeRequestImpl;
