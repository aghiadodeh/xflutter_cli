...
import 'package:products/src/data/database/products_store.dart';
import 'package:products/src/data/models/local/product/local_product.dart';
import 'package:products/src/data/database/objectbox.g.dart';

@LazySingleton(scope: 'products', as: ProductsLocalDataSource)
class ProductsLocalDataSourceImpl implements ProductsLocalDataSource {
  final ObjectBoxProductsStore _productsStore;
  ProductsLocalDataSourceImpl(this._productsStore);
  ...
  Future<void> insertAll(Iterable<LocalProduct> data) async {
    final store = _productsStore.openStore();
    // open transaction
