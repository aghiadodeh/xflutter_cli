...
@LazySingleton(scope: 'changePassword')
class ChangePasswordViewModel extends BaseViewModel {
  final params = ChangePasswordParams();
  final AuthenticationRepository _authenticationRepository;
  ChangePasswordViewModel(this._authenticationRepository);
  ...
  void submit() {
    ...
    final request = ChangePasswordRequest.fromJson(params.changePasswordForm.value);
    callHttpRequest(
      () => _authenticationRepository.changePassword(request),
